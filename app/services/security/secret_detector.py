        ...
        self.rules = [
            {
                ...
                "pattern": re.compile(
                    r"(?i)(?:aws_access_key_id|aws_secret_access_key|aws_session_token).*?['\"]([A-Za-z0-9/+=]{20,40})['\"]"
                ),
            ...
            },
            {
                ...
                "pattern": re.compile(
                    r"(?i)(?:github_token|gh_token|ghp_[a-zA-Z0-9]{36}).*?['\"]([a-zA-Z0-9]{36,40})['\"]"
                ),
            ...
            },
            {
                ...
                "pattern": re.compile(
                    r"(?i)(?:password|passwd|pwd|secret|auth_token).*?=\\s*['\"]([^'\"]{6,})['\"]"
                ),
            ...
            },
            {
                "id": "database_url",
                "pattern": re.compile(
                    r"(?i)(?:postgres|mysql|mongodb|redis|sqlite)(?:ql)?://[\w\-]+:[^@\s]+@[\w\-.]+:\d+/[\w\-]+"
                ),
                ...
                if rule["pattern"].search(line):
                    issues.append(
                        SecurityIssue(
                            ...
                            why_it_matters="Hardcoded secrets can be exploited by attackers to gain unauthorized access.",
